 ...
 * Generated at: 2024-10-23 05:09:19 UTC
...
public final class ex03_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    ex03.jsp p.417\r\n");
      out.write("    [커넥션 풀(Connection pool)]\r\n");
      out.write("	기본값    메서드                          설명                                                                      																	 기본값\r\n");
      out.write("		8	setMaxTotal(int)               풀에서 관리하는 커넥션의 최대 개수를 설정한다. 음수면 제한이 없다.                																8												\r\n");
      out.write("		8	setMaxIdle(int)                커넥션 풀이 보관할 수 있는 최대 유휴 개수를 지정한다. 음수면 제한이 없다.         																 8\r\n");
      out.write("	\r\n");
      out.write("		0	setMinIdle(int)                커넥션 풀이 유지할 최소 유휴 커넥션 개수를 지정한다. 이 값이 maxIdle 보다 크면 maxIdle을 minIdle 값으로 사용한다. 								0\r\n");
      out.write("	 true	setBlockWhenExhausted(boolean) 풀에 관리하는 커넥션이 모두 사용중인 상태에서 커넥션을 요청할 때 풀에 커넥션이 반환될 때까지 대기할지 여부를 지정한다. \r\n");
      out.write("											true면 대기하고, false면 NoSuchElementException을 발생한다. 																					true\r\n");
      out.write("	  -1L	setMaxWaitMillis(long)          blockWhenExhausted가 true일 때, 최대 대기 시간을 설정한다. 음수면 풀에서 커넥션을 구할 수 있을 때까지 대기한다. 단위는 밀리초이다. 				-1L\r\n");
      out.write("	  \r\n");
      out.write("	  https://tomcat.apache.org/tomcat-9.0-doc/jndi-datasource-examples-howto.html\r\n");
      out.write("	  \r\n");
      out.write("	  ㄱ. tomcat\r\n");
      out.write("  </xmp>\r\n");
      out.write("  \r\n");
